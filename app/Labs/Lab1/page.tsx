    ...
    <div id="wd-lab1">
      ...
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
          ...
          HTML heading tags can be used to format plain text so that it renders in a 
          browser as large headings. There are 6 heading tags for different sizes: 
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: Butter Pasta!
        <ol id="wd-your-favorite-recipe">
          <ol> 
            <li> Boil pasta. </li>
            <li> Preep ingredients. </li>
            <li> Melt Butter. </li>
            <li> Cook Garlic. </li>
      ...
      <div id="wd-forms">
        ...
        Github Link:
        Please
        <a href="https://github.com/MigChi/kambas-next-js" id="wd-github"> click here </a>
        to get dummy text<br/>
      </div>
    </div>
);}
